...
| Pipeline IA (estrutural, BYOK OpenAI) | `extractor-tick` (cron */10 — extrai custom fields de texto), `vision-tick` (cron */10 — analisa comprovantes), `audio-tick` (cron */5 — Whisper PT), `field-rules-tick` (cron */2 — move card por regras AND), `field-rules-suggest` (heurística pra UI), `clinic-openai-key` (valida+grava BYOK) | [`../maps/AI_RUNTIME.md`](../maps/AI_RUNTIME.md), [`../flows/PIPELINE_DERIVED.md`](../flows/PIPELINE_DERIVED.md) |
