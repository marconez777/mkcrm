...
_Gerado por `scripts/docs-sync.mjs` em 2026-06-07T22:05:44.874Z_

Total de docs: **146** · frontmatter atualizado neste run: **146**
...
- `admin-user-action`
- `admin-users-list`
- `agent-followups-tick`
- `agent-learn-from-thread`
- `agent-run-bulk`
- `ai-analyst-run`
- `ai-assist`
- `ai-auto-reply`
...
- `dispatch-campaign`
- `eduzz-webhook`
- `email-automations-tick`
- `email-domain-manage`
- `email-unsubscribe`
- `evolution-backfill-all`
- `evolution-collect-leads`
- `evolution-delete-instance`
- `evolution-delete-lead`
- `evolution-delete-message`
