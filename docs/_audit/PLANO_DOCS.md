...
> ⚠️ **Consequência a assumir:** sem validador, nada impede `code_refs` quebrado de
> voltar. Foi exatamente o que aconteceu entre 18/06 e hoje. A mitigação fica como
> item aberto no [roadmap](../roadmap/ROADMAP_ATUALIZACAO_DOCUMENTACAO.md).
