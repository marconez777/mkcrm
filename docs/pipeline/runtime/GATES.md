...
| **G10** | Humano > IA em conflitos recentes (<7d) em custom_fields | **NÃO IMPLEMENTADO** hoje — classifier sobrescreve livremente. Mitigação: prompt diz "só inclua chaves se há evidência clara". | — |
