        ...
        <ul className="mt-14 grid gap-5 md:grid-cols-3">
          {POSTS.map(({ icon: Icon, ...p }) => (
            <li key={p.title}>
              <a
                href="#"
                className="group relative flex h-full flex-col gap-6 overflow-hidden rounded-3xl border border-white/10 bg-site-surface p-7 transition-all hover:-translate-y-1 hover:border-site-primary/50"
              >
                ...
                <span className="site-font-body mt-auto text-[12px] text-site-muted">
                  {p.read}
                </span>

                <div
                  aria-hidden
                  className="pointer-events-none absolute -bottom-20 -right-20 h-48 w-48 rounded-full opacity-0 blur-3xl transition-opacity group-hover:opacity-100"
                  style={{
                    background:
