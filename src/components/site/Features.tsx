...
const CARDS = [
  ...
  },
  {
    ...
    body: "Um agente responde no WhatsApp 24/7 com a base de conhecimento do negócio. Outro observa em silêncio e move os cards no Kanban, tagueia e cria tarefas. Um terceiro entrega um resumo de cada conversa. Tudo com controle de orçamento mensal.",
  },
] as const;
