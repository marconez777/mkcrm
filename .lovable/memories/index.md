...
Classifier (gpt-5/mini/nano por agente) roda 1/min, valida datas via sanitizeDateField (anchor=última msg), tem PROTECTED_TAGS, advisory lock `try_classify_lock`, backoff escalonado 2/5/30min, e 429 backoff exponencial em `withSchemaRetry`.
