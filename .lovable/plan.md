...
### Fase 6 — Integrações + Operações + Known issues + Roadmap + Conventions + Site (16 arquivos) — **parcial 2026-06-03**
`integrations/*.md` (5) ✅ + `operations/*.md` (5) ✅ concluídos. Restam: `known-issues/*` (3), `roadmap/*` (3), `conventions/*` (4), `site/FEATURE_PAGES.md` (1).
